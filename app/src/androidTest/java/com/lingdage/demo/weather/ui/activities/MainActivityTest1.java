...
public class MainActivityTest1 {
    ...
    public void mainActivityTest1() {
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.forecastList),
                        childAtPosition(
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.cityCode), withText("94043"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.FrameLayout")),
                                        1),
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.cityCode), withText("94043"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("94046"));

        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.cityCode), withText("94046"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.FrameLayout")),
                                        1),
